...
export function UpdatePrompt({ open, onApply, onDismiss }: UpdatePromptProps) {
    ...
    return (
        ...
        >
            <div className="mx-auto flex max-w-md items-center gap-3 rounded-lg bg-paper-900 px-4 py-3 text-paper-50 shadow-[0_12px_32px_-12px_oklch(0.2_0.01_271/0.45)]">
